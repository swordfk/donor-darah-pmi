...
public class ViewPendonor2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pendonor2);
        ...
        call.enqueue(new Callback<List<Pendonor>>() {
            ...
            public void onResponse(Call<List<Pendonor>> call, Response<List<Pendonor>> response) {
                if (response.code()==200){
                    ...
                    adapter = new AdapterPendonor(ViewPendonor2.this, kpmiResponseList);
                    recyclerView.setAdapter(adapter);
                }else {
                    Toast.makeText(ViewPendonor2.this,response.code()+ " "+response.message(), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Pendonor>> call, Throwable t) {
                Toast.makeText(ViewPendonor2.this,t.getMessage()+ "", Toast.LENGTH_SHORT).show();
            }
        });
